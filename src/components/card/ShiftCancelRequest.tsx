...
import { RequestStatus, RequestType } from "@models/enums";
import {
  CheckCircleIcon,
  XCircleIcon,
...
function ShiftChangeRequest(props: Props) {
  ...
  const { status, oldShift, requestDate, description } = details;
  ...
  return (
    <div className="relative card bg-neutral font-medium shadow-lg p-4">
      ...
      <div className="flex flex-col my-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center rounded-full bg-zinc-100 shadow-sm py-2 px-1 w-full">
            <XCircleIcon className="h-10 w-10 text-gray-700 p-2" />
